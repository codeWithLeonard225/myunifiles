...
import DataFormsPage from "./DataFormsPage";
import LoginLogsPage from "../Auth/LoginLogsPage";
...
const NAV_ITEMS = [
  {
    ...
    icon: <MdEdit />,
    children: [
      { key: "Ceo", label: " Form", icon: <MdPerson /> },
      { key: "AdminSignup", label: " Admin Signup", icon: <MdPerson /> },
      { key: "DataFormsPage", label: " DataForms Page ", icon: <MdPerson /> },
  ...
  },
  {
    ...
    icon: <MdBarChart />,
    children: [
     { key: "StudentReport", label: "Student Report ", icon: <MdBarChart /> },
...
function AdminPanel() {
  ...
  const renderNavItems = (items, level = 0) =>
   ...
   const renderContent = () => {
    switch (activeTab) {
      case "dashboard": return <LoginLogsPage />;
      case "Ceo": return <CeoForm/>;
      case "AdminSignup": return <AdminSignup/>;
      case "DataFormsPage": return <DataFormsPage/>;
      case "StudentReport": return <StudentReport/>;
